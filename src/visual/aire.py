...
class AireLugar(object):
    ...
    def init_view(self):
        ...
        self.actualizar_gui()
        if info[0] == "apagado":
            self.cambiar_estado_btns(True)
        else:
            self.cambiar_estado_btns(False)
    ...
    def cambiar_estado_btns(self, estado):
        ...
        self.btn_subir_temp.setDisabled(estado)
        self.btn_bajar_temp.setDisabled(estado)
