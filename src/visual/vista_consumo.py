...
class VistaConsumo(object):
    def setupUi(self, Dialog):
        ...
        self.tbobjetos.setGeometry(QtCore.QRect(40, 170, 621, 300))
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Costo(RD$)"))
    ...
    def buscarConsumoDeObjeto(self, Query):
        ...
        if Query == "<Todos>":
            ...
            for solution in Q1:
                ...
                elec.update(
                    {nombre: str(solution["X"]), consumo: str(solution["Consumo"]), precio: str(solution["Precio"])})
                    ...
                    for aux3 in range(0, len(electrodomestico)):
                        ...
                        if mensaje.lower() == busqueda:
                            auxDict.update({"Electrodomestico #" + str(nom): elec["Electrodomestico #" + str(ind)],
                                            ...
                                            "Precio #" + str(nom): elec["Precio #" + str(ind)]})
                            count += 1
                            nom += 1
                            break
